...
export interface CVProfile {
  ...
  suggestedInterviewTracks: QuestionCategory[];
...
export type AtsGrade = "Excellent" | "Good" | "Needs Improvement" | "Weak";
...
export type JobMatchGrade = "Excellent Match" | "Strong Match" | "Moderate Match" | "Weak Match";

export interface JobMatchAnalysis {
  matchScore: number;
  matchGrade: JobMatchGrade;
